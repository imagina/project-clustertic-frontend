...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "search-project-bg tw-bg-black" }, _attrs))} data-v-89978909><div class="tw-container tw-flex tw-justify-center tw-py-16" data-v-89978909><div class="tw-basis-2/3 lg:tw-basis-3/6" data-v-89978909><h3 class="tw-font-light tw-text-white tw-text-center tw-text-[32px] tw-mb-14" data-v-89978909> \xBFQu\xE9 est\xE1s buscando? </h3>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-89978909"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=searchProject-CPl_kmTa.mjs.map
