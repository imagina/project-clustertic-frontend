            ...
            if (_push3) {
              _push3(ssrRenderComponent(_component_CardTitle, { class: "!tw-font-medium" }, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`T\xE9rminos del Servicio`);
                  } else {
                    return [
                      createTextVNode("T\xE9rminos del Servicio")
                    ];
                  }
                }),
                _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/termsAndConditions.vue");
...
//# sourceMappingURL=termsAndConditions-BTu_gKbz.mjs.map
