...
<template>
  <div
    class="tw-min-h-screen tw-bg-gray-100 tw-text-gray-900 tw-flex tw-justify-center"
  >
    <div
      class="tw-max-w-screen-xl tw-m-0 sm:tw-m-10 tw-bg-white tw-shadow sm:tw-rounded-lg tw-flex tw-justify-center tw-flex-1"
    >
      <div class="lg:tw-w-1/2 xl:tw-w-5/12 tw-p-6 sm:tw-p-12">
        <div class="tw-mt-12 tw-flex tw-flex-col tw-items-center">
          <h1 class="tw-text-2xl xl:tw-text-3xl tw-font-extrabold">Login</h1>
          <div class="tw-w-full tw-flex-1 tw-mt-8">
            ...
            <div class="tw-mx-auto tw-max-w-xs">
              ...
              <p class="tw-mt-6 tw-text-xs tw-text-gray-600 tw-text-center">
                ...
                <a
                  href="#"
                  class="tw-border-b tw-border-gray-500 tw-border-dotted"
                >
                  Terms of Service
                </a>
                and its
      ...
      <div
        class="tw-flex-1 tw-bg-indigo-100 tw-text-center tw-hidden lg:tw-flex"
      >
        <div
          class="tw-m-12 xl:tw-m-16 tw-w-full tw-bg-contain tw-bg-center tw-bg-no-repeat"
          style="
