...
const isEmpty = computed(() => auth.password == '' || auth.newPassword == '' || auth.newPasswordConfirmation == '')
const isDiferent = computed(() => auth.newPassword !=  auth.newPasswordConfirmation) 
...
<template>
  <div
    class="tw-min-h-screen tw-flex tw-justify-center"
  >
    <div
